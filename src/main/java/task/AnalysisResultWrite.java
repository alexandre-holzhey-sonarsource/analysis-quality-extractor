...
import static task.AnalysisResultFromFile.OUTPUT_FOLDER;
...
public class AnalysisResultWrite {
  private static final String SC_STAGING_URL = "https://peach.sonarsource.com";
...
//    "org.apache.rocketmq:rocketmq-all"
  ...
  public static void main(String[] args) throws IOException {
    ...
    for (Component baseComponent : baseComponents) {
      ...
      FileWriter fileWriter = new FileWriter(outputFolder + paqExtracted.getBaseComponent().getKey().replaceAll(":", "_"));
